...
namespace EnhancedBattery
{
    ...
    public class CompChargeBackPowerPlant : CompChargeBackPowerPlantPrototype
    {
        ...
        public override void UpdateDesiredPowerOutput()
        {
            ...
            if (compPowerBattery != null)
            {
                ...
                PowerOutput = -(Props.PowerConsumption * currentPowerEfficiency);
                return;
            }
            PowerOutput = 0;
        }
    ...
    public class CompResonancePowerPlant : CompChargeBackPowerPlant
    {
        ...
        public override string CompInspectStringExtra()
        {
            ...
            string str;
            str = "PowerOutput".Translate() + ": " + (-Props.PowerConsumption * currentPowerEfficiency).ToString("#####0") + " W";
            return str;
        ...
        public override void Tick()
        {
            ...
            if (this.ticksToExplode > 0)
            {
                ...
                if (this.ticksToExplode == 0)
                {
                    ...
                    GenExplosion.DoExplosion(randomCell, base.Map, radius, DamageDefOf.Flame, null, -1, -1f, null, null, null, null, null, 0f, 1,null, false, null, 0f, 1, 0f, false);
